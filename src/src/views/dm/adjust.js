...
class DaoMianAdjust extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
...
DaoMianAdjust.contextTypes = contextTypes;

DaoMianAdjust.propTypes = propTypes;

DaoMianAdjust = Form.create()(DaoMianAdjust);
...
export default connect(mapStateToProps, mapDispatchToProps)(DaoMianAdjust)